...
public class FeedDaoImpl implements FeedDao {
    ...
    public Feed postEvent(Feed feed) {
        String sqlInsert = "INSERT INTO feed (user_id, event_type, operation, entity_id) " +
                "VALUES (?, ?, ?, ?)";
        KeyHolder keyHolder = new GeneratedKeyHolder();

        jdbcTemplate.update(connection -> {
            PreparedStatement stmt = connection.prepareStatement(sqlInsert, new String[]{"event_id", "event_time"});
